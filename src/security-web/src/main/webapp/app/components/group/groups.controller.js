 ...
 */
angular.module("app").controller("GroupsController", ["$uibModal", "$q", "GroupService", "GroupBundle", "DialogService",
    function ($uibModal, $q, GroupService, GroupBundle, DialogService) {
        "use strict";
        var vm = this;
        ...
        vm.remove = function () {
            ...
            vm.bundle.pageGroups.forEach(function (group) {
                if (group.checked) tasks.push(GroupService.remove(group.id))
            });
